...
# 방출점 15 cm 에서 가로 8 x 세로 5 cm)에서 왔고, 조리개만 원본보다 15% 넓혔다(아래 SCAN_CAM, 2026-09-26).
...
#   세로 시야가 좁아 빔보다 2~3 cm 높게 든 제시가 잘리던 것을 줄이려는 것이었다.
# 2026-09-26: 원본 대비 **15%** 로 조정한다 (조리개 24.09825 x 15.06155 mm, 초점거리 그대로).
#   화각 가로 42.0 x 세로 26.9 도 (원본 36.9 x 23.5, 30% 판 46.9 x 30.3). 방출점 15 cm 에서 가로 9.2 x 세로 5.75 cm 를 본다.
#   채점기 화면 점유율의 카메라(`trace_write.SCANNER_CAM`)도 같은 가로 조리개로 함께 바꾼다.
SCAN_CAM = (800, 500, 31.43, 24.09825, 15.06155, 0.03, 0.30)
